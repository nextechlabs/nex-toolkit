...
Install `@nextechlabs/profile-sdk` into your project with npm:

```bash
npm install @nextechlabs/profile-sdk --save
```

or yarn:

```bash
yarn add @nextechlabs/profile-sdk
```
...
```js
import PancakeProfileSdk from "@nextechlabs/profile-sdk";
...
```JSX
import { Team, teamImages } from "@nextechlabs/profile-sdk";
